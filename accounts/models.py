...
class CustomUserManager(BaseUserManager):
    ...
    def create_superuser(self, email, username, password, firstname, lastname, **extra_fields):
        """
        ...
        return self.create_user(email,username, password, firstname, lastname, **extra_fields)
